<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.incorrect" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("    <title>我的错题 - " + pagetitle.ToString() + "</title>\r\n");
	...
	ViewBuilder.Append("                            <li class=\"active\"><a href=\"incorrect.aspx\">我的错题</a></li>\r\n");
	...
	ViewBuilder.Append("                                    <div class=\"name\">共有" + total.ToString() + "道错题</div>\r\n");
	ViewBuilder.Append("                                </div>\r\n");
	...
	ViewBuilder.Append("                                                        <a href=\"questionview.aspx?sortid=" + item.sortid.ToString().Trim() + "&action=wrong\" target=\"_blank\" class=\"btn btn-link link-button\">" + item.sortname.ToString().Trim() + "(共" + item.wrongs.ToString().Trim() + "道错题)</a>\r\n");

	}
	else
	{

	ViewBuilder.Append("                                                        " + item.sortname.ToString().Trim() + "(共" + item.wrongs.ToString().Trim() + "道错题)\r\n");
	...
	ViewBuilder.Append("                                                    <a href=\"questionview.aspx?sortid=" + item.sortid.ToString().Trim() + "&action=wrong\" target=\"_blank\" class=\"btn btn-link link-button\"><span class=\"btn-inner\">查看题目</span></a>&nbsp;&nbsp;\r\n");
	ViewBuilder.Append("                                                    <a href=\"testview_csk.aspx?sortid=" + item.sortid.ToString().Trim() + "\" target=\"_blank\" class=\"btn btn-link link-button\"><span class=\"btn-inner\">专项练习</span></a>\r\n");
	...
	ViewBuilder.Append("                                                    <span class=\"btn-inner\">专项练习</span>\r\n");
