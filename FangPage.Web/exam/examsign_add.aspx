...
protected override void View()
{
	...
	ViewBuilder.Append("    <tbody>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("        <td bgcolor=\"#F0F0F0\" width=\"147\" style=\"text-align:center\"><strong>上传付款凭证</strong></td>\r\n");
	ViewBuilder.Append("        <td style=\"width:400px;font-size:12px;line-height:20px;\">\r\n");
	ViewBuilder.Append("            <img src=\"" + echo(examsigninfo.payimg) + "\" width=\"100\" height=\"100\">\r\n");
	ViewBuilder.Append("            <br>\r\n");
	ViewBuilder.Append("           <input id=\"payimg\" name=\"payimg\" style=\"width:300px;\" type=\"file\"><br>\r\n");
	ViewBuilder.Append("           <div style=\"font-size:12px;line-height:20px;\">\r\n");
	ViewBuilder.Append("           请扫右边二维码付款，付款完后截图上传，图片大小为200K至2M之间，格式为JPG/PNG<br>\r\n");
	ViewBuilder.Append("           如果不上传付款凭证或凭证错误，审核将不通过。\r\n");
	ViewBuilder.Append("           </div>\r\n");
	ViewBuilder.Append("        </td>\r\n");
	ViewBuilder.Append("        <td>\r\n");
	ViewBuilder.Append("          <img src=\"" + echo(webpath) + "" + echo(sitepath) + "/logo/wx.jpg\" width=\"200\" height=\"250\">\r\n");
	ViewBuilder.Append("          <img src=\"" + echo(webpath) + "" + echo(sitepath) + "/logo/zfb.jpg\" width=\"200\" height=\"250\">\r\n");
	ViewBuilder.Append("        </td>\r\n");
	ViewBuilder.Append("      </tr>\r\n");
	ViewBuilder.Append("    </tbody>\r\n");
	ViewBuilder.Append("  </table>\r\n");
