<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.testpost" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>练习结束 - " + pagetitle.ToString() + "</title>\r\n");
	...
	ViewBuilder.Append("        <div class=\"ta_c bx4\"> 恭喜您顺利完成本次练习！<span id=\"testScore\">练习总得分：<span>" + examresult.score.ToString().Trim() + "</span>分</span> </div>\r\n");
	ViewBuilder.Append("        <div id=\"tip\" class=\"ta_c mb20 ft12\">想知道自己的练习情况吗？点击下面的按钮查看详情</div>\r\n");
	ViewBuilder.Append("          <div class=\"ta_c mb10\"> \r\n");
	ViewBuilder.Append("          <a id=\"analisisLink\" href=\"examresult.aspx?resultid=" + examresult.id.ToString().Trim() + "\" class=\"btnq3\">练习分析</a> \r\n");
