<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.favorite" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("    <title>我的收藏 - " + pagetitle.ToString() + "</title>\r\n");
	...
	ViewBuilder.Append("                                    <div class=\"name\">共收藏" + total.ToString() + "道题目</div>\r\n");
	ViewBuilder.Append("                                </div>\r\n");
	...
	ViewBuilder.Append("                                                        <a href=\"questionview.aspx?sortid=" + item.sortid.ToString().Trim() + "&action=fav\" target=\"_blank\" class=\"btn btn-link link-button\">" + item.sortname.ToString().Trim() + "(共" + item.favs.ToString().Trim() + "道收藏)</a>\r\n");

	}
	else
	{

	ViewBuilder.Append("                                                        " + item.sortname.ToString().Trim() + "(共" + item.favs.ToString().Trim() + "道收藏)\r\n");
	...
	ViewBuilder.Append("                                                    <a href=\"questionview.aspx?sortid=" + item.sortid.ToString().Trim() + "&action=fav\" target=\"_blank\" class=\"btn btn-link link-button\"><span class=\"btn-inner\">查看题目</span></a>\r\n");
