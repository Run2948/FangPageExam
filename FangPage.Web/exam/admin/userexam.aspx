<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.userexam" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>已选用户</title>\r\n");
	...
	ViewBuilder.Append("    function DeleteUser(id)\r\n");
	ViewBuilder.Append("    {\r\n");
	ViewBuilder.Append("        $(\"#uid\").val(id);\r\n");
	...
	ViewBuilder.Append("  <input id=\"uid\" name=\"uid\" value=\"\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("               <td>" + item.Department.name.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("               <td><a href=\"javascript:DeleteUser(" + item.id.ToString().Trim() + ")\">删除</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
