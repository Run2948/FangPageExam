<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.examadd" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("        PageNav(\"" + GetSortNav(sortinfo,navurl).ToString() + "|添加编辑考试," + rawurl.ToString() + "\");\r\n");
	...
	ViewBuilder.Append("            window.location.href = \"exammanage.aspx?sortid=" + sortid.ToString() + "\";\r\n");
	ViewBuilder.Append("        });\r\n");
	...
	ViewBuilder.Append("            examuser: '" + examinfo.examuser.ToString().Trim() + "',\r\n");
	...
	ViewBuilder.Append("  <input id=\"tabactive\" name=\"tabactive\" value=\"" + tabactive.ToString() + "\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("><a href=\"#\">试卷设置</a></li>\r\n");

	if (id>0)
	{

	ViewBuilder.Append("            <li class=\"normal\"><a href=\"examexpmanage.aspx?examid=" + id.ToString() + "\">奖励设置</a></li>\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">考试基本设置，所在栏目：" + sortinfo.name.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("            <td><input name=\"name\" type=\"text\" value=\"" + examinfo.name.ToString().Trim() + "\" id=\"name\" style=\"height:21px;width:300px;\"></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 考试分类： </td>\r\n");
	...
	ViewBuilder.Append("              <select id=\"typeid\" name=\"typeid\">\r\n");
	...
	ViewBuilder.Append("            <td><input name=\"passmark\" type=\"text\" value=\"" + examinfo.passmark.ToString().Trim() + "\" id=\"passmark\" style=\"height:21px;width:300px;\">&nbsp;%(百分比)</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 考试次数： </td>\r\n");
	ViewBuilder.Append("            <td><input name=\"repeats\" type=\"text\" value=\"" + examinfo.repeats.ToString().Trim() + "\" id=\"repeats\" style=\"height:21px;width:300px;\">&nbsp;0为无限制</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 答题时间： </td>\r\n");
	ViewBuilder.Append("            <td><input name=\"examtime\" type=\"text\" value=\"" + examinfo.examtime.ToString().Trim() + "\" id=\"examtime\" style=\"height:21px;width:300px;\">&nbsp;分钟</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	...
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                <input name=\"starttime\" type=\"text\" value='" + FangPage.MVC.FPUtils.GetDate(examinfo.starttime,"yyyy-MM-dd HH:mm") + "' id=\"starttime\" onfocus=\"WdatePicker({el:'starttime',dateFmt:'yyyy-MM-dd HH:mm'})\" readonly=\"readonly\" style=\"height:21px;width:120px;\">至\r\n");
	ViewBuilder.Append("                <input name=\"endtime\" type=\"text\" value='" + FangPage.MVC.FPUtils.GetDate(examinfo.endtime,"yyyy-MM-dd HH:mm") + "' id=\"endtime\" onfocus=\"WdatePicker({el:'endtime',dateFmt:'yyyy-MM-dd HH:mm'})\" readonly=\"readonly\" style=\"height:21px;width:120px;\">\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	...
	ViewBuilder.Append("      <tbody>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">考试权限设置，所在栏目：" + sortinfo.name.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	ViewBuilder.Append("      </table>\r\n");
	ViewBuilder.Append("      <table style=\"width:100%;\" cellpadding=\"2\" cellspacing=\"1\" class=\"border\">\r\n");
	ViewBuilder.Append("        <tbody>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("        <td class=\"td_class\"> 使用积分： </td>\r\n");
	ViewBuilder.Append("        <td><input name=\"credits\" type=\"text\" value=\"" + examinfo.credits.ToString().Trim() + "\" id=\"credits\" style=\"height:21px;width:300px;\"></td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("        <input id=\"examroles\" name=\"examroles\" value=\"" + roles.id.ToString().Trim() + "\" \r\n");
	...
	ViewBuilder.Append(" type=\"checkbox\">" + roles.name.ToString().Trim() + "\r\n");
	...
	ViewBuilder.Append("          <input id=\"examuser\" name=\"examuser\" value=\"" + examinfo.examuser.ToString().Trim() + "\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("      <tbody>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">试卷简介，所在栏目：" + sortinfo.name.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	ViewBuilder.Append("      </table>\r\n");
	ViewBuilder.Append("      <table style=\"width:100%;\" cellpadding=\"2\" cellspacing=\"1\" class=\"border\">\r\n");
	ViewBuilder.Append("        <tbody>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("        <td class=\"td_class\"> 试卷标题： </td>\r\n");
	ViewBuilder.Append("        <td><input name=\"description\" type=\"text\" value=\"" + examinfo.description.ToString().Trim() + "\" id=\"description\" style=\"height:21px;width:400px;\"></td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("        <td class=\"td_class\"> 试卷说明： </td>\r\n");
	ViewBuilder.Append("        <td>\r\n");
	ViewBuilder.Append("         <textarea id=\"content\" name=\"content\" style=\"width:100%; height:300px\" cols=\"20\" rows=\"2\">" + examinfo.content.ToString().Trim() + "</textarea>\r\n");
	ViewBuilder.Append("        </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"></td>\r\n");
