<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.examconfig" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("            <td><input name=\"autotime\" type=\"text\" value=\"" + examconfiginfo.autotime.ToString().Trim() + "\" id=\"autotime\" style=\"height:21px;width:200px;\">&nbsp;分钟，0为不自动保存。</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 练习最大题数： </td>\r\n");
	ViewBuilder.Append("            <td><input name=\"testcount\" type=\"text\" value=\"" + examconfiginfo.testcount.ToString().Trim() + "\" id=\"testcount\" style=\"height:21px;width:200px;\">&nbsp;道，必须大于0。</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 练习时间： </td>\r\n");
	ViewBuilder.Append("            <td><input name=\"testtime\" type=\"text\" value=\"" + examconfiginfo.testtime.ToString().Trim() + "\" id=\"testtime\" style=\"height:21px;width:200px;\">&nbsp;分钟，必须大于0。</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"1\" \r\n");
	...
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"2\" \r\n");
	...
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"3\" \r\n");
	...
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"4\" \r\n");
	...
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"5\" \r\n");
	...
	ViewBuilder.Append("                <input id=\"questiontype\" name=\"questiontype\" value=\"6\" \r\n");
