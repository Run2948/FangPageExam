<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.Exam.Controller.exampost" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>考试结束 - " + pagetitle.ToString() + "</title>\r\n");
	...
	ViewBuilder.Append("        <h1 class=\"qtTitle\">" + examresult.examname.ToString().Trim() + "</h1>\r\n");
	ViewBuilder.Append("        <div class=\"ta_c bx4\">恭喜您顺利完成本次考试！<span id=\"testScore\">您的得分为<span>" + examresult.score.ToString().Trim() + "</span>分</span>\r\n");
	...
	ViewBuilder.Append(" " + examresult.exnote.ToString().Trim() + "，\r\n");

	}	//end if

	ViewBuilder.Append("              考试获得经验值为" + examresult.exp.ToString().Trim() + "。\r\n");
	...
	ViewBuilder.Append("          <a id=\"analisisLink\" href=\"examresult.aspx?resultid=" + examresult.id.ToString().Trim() + "\" class=\"btnq3\">考试分析</a> \r\n");
	ViewBuilder.Append("          <a id=\"answerLink\" href=\"examanswer.aspx?resultid=" + examresult.id.ToString().Trim() + "\" class=\"btnq3 ml2\">答案解析</a>\r\n");
	ViewBuilder.Append("          </div>\r\n");
	ViewBuilder.Append("      </div>\r\n");
