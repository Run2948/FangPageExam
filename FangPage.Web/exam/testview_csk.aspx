...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>强化练习 - " + pagetitle.ToString() + "</title>\r\n");
	...
	ViewBuilder.Append("	background: url(" + webpath.ToString() + "sites/exam/statics/images/examtype2.png) no-repeat;\r\n");
	...
	ViewBuilder.Append("  <input type=\"hidden\" id=\"testtype\" name=\"testtype\" value=\"1\">\r\n");
	...
	ViewBuilder.Append("              <td height=\"50\" colspan=\"2\" align=\"center\" style=\"background:#fffbe1\"><span style=\"font-size:17px;text-align: center;color:#444;font-weight:bold; font-family:'微软雅黑'\">强化练习</span></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	...
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td width=\"120\" height=\"30\" align=\"center\" style=\"background:#fff url(" + webpath.ToString() + "sites/exam/statics/images/trbg.png) no-repeat 0 100%; padding-left:20px;\">练习题库：</td>\r\n");
	ViewBuilder.Append("              <td align=\"left\" style=\"background:#fff url(" + webpath.ToString() + "sites/exam/statics/images/trbg.png) no-repeat -270px 100%; padding-left:5px;border-left:1px solid #f4ecd2\">\r\n");
	...
	ViewBuilder.Append("    <img id=\"btnsumit\" src=\"" + webpath.ToString() + "sites/exam/statics/images/btn2.png\" style=\"cursor:pointer;\" border=\"0\">\r\n");
	ViewBuilder.Append("  </div>\r\n");
