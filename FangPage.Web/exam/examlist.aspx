...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("><a href=\"examlist.aspx?channelid=" + channelid.ToString() + "\">全部</a></li>\r\n");
	...
	ViewBuilder.Append("><a href=\"examlist.aspx?channelid=" + channelid.ToString() + "&sortid=" + sorts.id.ToString().Trim() + "\">" + sorts.name.ToString().Trim() + "</a></li>\r\n");
	...
	ViewBuilder.Append("                      <span class=\"btn btn-normal open-exercise\"><span onclick=\"ExamContinu(" + item.id.ToString().Trim() + ");\" class=\"btn-inner\">开始考试</span></span>\r\n");
	ViewBuilder.Append("                  </div>\r\n");
	ViewBuilder.Append("                  <div class=\"name\"><a href=\"examview.aspx?examid=" + item.id.ToString().Trim() + "\" target=\"_blank\">" + item.name.ToString().Trim() + "</a></div>\r\n");
	ViewBuilder.Append("                  <div class=\"meta\">\r\n");

	if (item.islimit==1)
	{

	ViewBuilder.Append("                      <span class=\"muted\">考试时间：" + FangPage.MVC.FPUtils.GetDate(item.starttime,"yyyy-MM-dd HH:mm") + "至" + FangPage.MVC.FPUtils.GetDate(item.endtime,"yyyy-MM-dd HH:mm") + "，</span>\r\n");
	...
	ViewBuilder.Append("                      <span class=\"muted\">考试人数：" + item.exams.ToString().Trim() + "人，平均分：" + item.avgscore.ToString().Trim() + "分</span></div>\r\n");
	ViewBuilder.Append("                </div>\r\n");
