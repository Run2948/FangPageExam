                ...
                <div class="box">
                    <div class="box-hd">
                        <ul class="nav nav-underline">
                            ...
                            <li class="active"><a href="favorite.aspx">我的收藏</a></li>
                        </ul>
                    </div>
                    <div class="box-bd">
                        <div class="exercise-list-wrap list-wrap">
                            <div class="list">
                                <div class="list-hd">
                                    <div class="name">共收藏${total}道题目</div>
                                </div>
                                <div class="list-bd">
                                            ...
                                            <tr class="keypoint keypoint-level-0">
                                                <td class="name-col">
                                                    <span class="text toggle-expand">
                                                        ...
                                                        <%if item.favs>0 %>
                                                        <a href="questionview.aspx?sortid=${item.sortid}&action=fav" target="_blank" class="btn btn-link link-button">${item.sortname}(共${item.favs}道收藏)</a>
                                                        <%else %>
                                                        ${item.sortname}(共${item.favs}道收藏)
                                                        <%/if %>
                                                    </span>
                                                </td>
                                                <td class="button-col">
                                                    <%if {item.favs}>0 %>
                                                    <a href="questionview.aspx?sortid=${item.sortid}&action=fav" target="_blank" class="btn btn-link link-button"><span class="btn-inner">查看题目</span></a>
                                                    <%else %>
