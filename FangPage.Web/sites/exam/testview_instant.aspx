<%controller(FangPage.Exam.Controller.testview) %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title>随机练习 - ${pagetitle}</title>
<%plugin(jquery)%>
<%plugin(layer) %>
<style type="text/css">
body {
...
.ptksbtn {
	width: 87px;
	height: 81px;
	background: url(statics/images/examtype1.png) no-repeat;
	position: absolute;
	left: -7px;
	top: -7px
}
...
<form name="frmpost" method="post" action="test.aspx" id="frmpost" onsubmit="layer.msg('系统正在组卷，请稍后...', 0, 1);">
  <input type="hidden" id="testtype" name="testtype" value="0"/>
      ...
      <div class="cbodywrap">
        <div id="cbody">
          ...
          <table width="100%" height="163" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td height="50" colspan="2" align="center" style="background:#fffbe1"><span style="font-size:17px;text-align: center;color:#444;font-weight:bold; font-family:'微软雅黑'">随机练习</span></td>
            </tr>
            <tr>
  ...
  <div style="text-align: center; line-height:30px;">
    <input type="image" name="starttest" id="starttest" src="statics/images/btn2.png" style="border-width:0px;"/>
  </div>
</form>
</body>
</html>