...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("        PageNav(\"" + pagenav.ToString() + "," + rawurl.ToString() + "\");\r\n");
	ViewBuilder.Append("    });\r\n");
	...
	ViewBuilder.Append("                <ul>\r\n");
	ViewBuilder.Append("                  <li style=\"background: url(../images/add.gif) 2px 6px no-repeat\"><a href=\"msgtemplateadd.aspx?type=" + type.ToString() + "\">添加</a></li>\r\n");
