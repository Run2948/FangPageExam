...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"操作权限管理,user/permissionmanage.aspx|添加编辑操作权限,user/" + pagename.ToString() + "?id={id}\");\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("          <input style=\"width: 300px\" id=\"name\" name=\"name\" value=\"" + permissioninfo.name.ToString().Trim() + "\">\r\n");
	...
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("            <textarea id=\"flagpage\" name=\"flagpage\" style=\"width: 300px; height:100px\">" + permissioninfo.flagpage.ToString().Trim() + "</textarea>\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
