...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("    <title>邮箱认证服务器配置</title>\r\n");
	...
	ViewBuilder.Append("                $(\"#frmpost\").submit();\r\n");
	ViewBuilder.Append("            })\r\n");
	ViewBuilder.Append("            PageNav(\"邮箱认证配置,global/" + pagename.ToString() + "\");\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">邮箱认证服务器配置</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                    <td><input name=\"password\" type=\"password\" value=\"" + emailconfig.password.ToString().Trim() + "\" id=\"password\" style=\"height:21px;width:300px;\"></td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	...
	ViewBuilder.Append("                    <td height=\"25\"><input id=\"testmail\" name=\"testmail\" type=\"text\" value=\"" + testmail.ToString() + "\" style=\"height:21px;width:300px;\"></td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
