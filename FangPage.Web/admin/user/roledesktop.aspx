<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.WMS.Admin.roledesktop" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("                        <li class=\"active\"><a href=\"roledesktop.aspx?rid=" + rid.ToString() + "\">桌面权限</a></li>\r\n");
	ViewBuilder.Append("                        <li class=\"normal\"><a href=\"rolepermission.aspx?rid=" + rid.ToString() + "\">操作权限</a></li>\r\n");
	ViewBuilder.Append("                    </ul>\r\n");
	...
	ViewBuilder.Append("                        <td class=\"newstitle\" bgcolor=\"#ffffff\">桌面权限设置，角色：【" + roleinfo.name.ToString().Trim() + "】</td>\r\n");
	ViewBuilder.Append("                    </tr>\r\n");
	ViewBuilder.Append("                </tbody>\r\n");
	...
	if (ischecked(item.id,roleinfo.desktop)||roleinfo.id==1)
	{

	ViewBuilder.Append("                                <td><input id=\"desktop\" name=\"desktop\" value=\"" + item.id.ToString().Trim() + "\" type=\"checkbox\" checked=\"checked\">" + item.name.ToString().Trim() + "</td>\r\n");

	}
	else
	{

	ViewBuilder.Append("                                <td><input id=\"desktop\" name=\"desktop\" value=\"" + item.id.ToString().Trim() + "\" type=\"checkbox\">" + item.name.ToString().Trim() + "</td>\r\n");
