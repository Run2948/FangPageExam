...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>系统日志管理</title>\r\n");
	...
	ViewBuilder.Append("        	  <td width=\"80\">操作人</td>\r\n");
	ViewBuilder.Append("              <td width=\"200\">操作名称</td>\r\n");
	ViewBuilder.Append("              <td>操作内容</td>\r\n");
	ViewBuilder.Append("              <td width=\"120\">操作时间</td>\r\n");
	ViewBuilder.Append("              <td width=\"100\">操作IP</td>\r\n");
	ViewBuilder.Append("              <td width=\"40\">结果</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("              <td>" + item.title.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("              <td align=\"left\">" + item.description.ToString().Trim() + "</td>\r\n");
