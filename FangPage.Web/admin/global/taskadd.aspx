...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("            })\r\n");
	ViewBuilder.Append("            PageNav(\"系统计划任务管理," + rawpath.ToString() + "taskmanage.aspx|添加编辑系统计划任务," + rawurl.ToString() + "\");\r\n");
	ViewBuilder.Append("        });\r\n");
	...
	ViewBuilder.Append("                                <td>\r\n");
	ViewBuilder.Append("                                    <input id=\"name\" name=\"name\" type=\"text\" value=\"" + taskinfo.name.ToString().Trim() + "\" style=\"height: 21px; width: 400px;\"></td>\r\n");
	ViewBuilder.Append("                            </tr>\r\n");
	ViewBuilder.Append("                            <tr>\r\n");
	ViewBuilder.Append("                                <td class=\"td_class\">计划任务类型： </td>\r\n");
	ViewBuilder.Append("                                <td>\r\n");
	ViewBuilder.Append("                                    <input id=\"type\" name=\"type\" type=\"text\" value=\"" + taskinfo.type.ToString().Trim() + "\" style=\"height: 21px; width: 400px;\"></td>\r\n");
	ViewBuilder.Append("                            </tr>\r\n");
	ViewBuilder.Append("                            <tr>\r\n");
	...
	ViewBuilder.Append("                                <input name=\"timeserval\" type=\"text\" id=\"timeserval\" value=\"" + taskinfo.minutes.ToString().Trim() + "\" \r\n");
