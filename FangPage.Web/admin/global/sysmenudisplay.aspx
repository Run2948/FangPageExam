...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"系统菜单管理,global/sysmenumanage.aspx|菜单排序管理,global/" + pagename.ToString() + "?parentid={parentid}\");\r\n");
	ViewBuilder.Append("    })\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("              <li style=\"background: url(../images/refresh.gif) 2px 6px no-repeat\"><a href=\"sysmenudisplay.aspx?parentid=" + parentid.ToString() + "\">刷新</a> </li>\r\n");
	ViewBuilder.Append("              <li style=\"background: url(../images/return.gif) 2px 6px no-repeat\"><a href=\"sysmenumanage.aspx\">返回</a> </li>\r\n");
	...
	ViewBuilder.Append("              <td align=\"left\">" + menu.name.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("              <td><input type=\"text\" style=\"width:200px;\" name=\"display_" + menu.id.ToString().Trim() + "\" id=\"display_" + menu.id.ToString().Trim() + "\" value=\"" + loop__id.ToString() + "\"></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
