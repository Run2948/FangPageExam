...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>后台桌面管理</title>\r\n");
	...
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"后台桌面管理,global/" + pagename.ToString() + "\");\r\n");
	ViewBuilder.Append("    })\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("              <li style=\"background: url(../images/add.gif) 2px 6px no-repeat\"><a href=\"desktopadd.aspx\">添加</a></li>\r\n");
	ViewBuilder.Append("              <li style=\"background: url(../images/refresh.gif) 2px 6px no-repeat\"><a href=\"desktopmanage.aspx\">刷新</a> </li>\r\n");
	ViewBuilder.Append("              <li style=\"float:right; width:auto\"><strong>后台桌面管理</strong></li>\r\n");
	ViewBuilder.Append("            </ul>\r\n");
	...
	ViewBuilder.Append("        	  <td>桌面快捷名称</td>\r\n");
	ViewBuilder.Append("        	  <td width=\"80\">图标</td>\r\n");
	ViewBuilder.Append("              <td>描述</td>\r\n");
	ViewBuilder.Append("              <td width=\"60\">隐藏</td>\r\n");
	ViewBuilder.Append("              <td width=\"60\">系统</td>\r\n");
	...
	ViewBuilder.Append("              <img src=\"" + item.icon.ToString().Trim() + "\" width=\"32\" height=\"32\" alt=\"" + item.name.ToString().Trim() + "\">\r\n");

	}
	else
	{

	ViewBuilder.Append("              <img src=\"../images/desktop.gif\" width=\"32\" height=\"32\" alt=\"" + item.name.ToString().Trim() + "\">\r\n");
	...
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td><a style=\"color: #1317fc\" href=\"desktopadd.aspx?id=" + item.id.ToString().Trim() + "\">编辑</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
