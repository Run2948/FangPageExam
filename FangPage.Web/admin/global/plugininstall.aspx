...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"系统插件管理,global/pluginmanage.aspx|安装插件,global/" + pagename.ToString() + "\");\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("                " + plugininfo.name.ToString().Trim() + "\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 插件版本： </td>\r\n");
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                " + plugininfo.version.ToString().Trim() + "\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td class=\"td_class\"> 插件作者： </td>\r\n");
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                " + plugininfo.author.ToString().Trim() + "\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                " + plugininfo.notes.ToString().Trim() + "\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("            <td>\r\n");
	ViewBuilder.Append("                <input id=\"installpath\" name=\"installpath\" type=\"text\" value=\"" + plugininfo.installpath.ToString().Trim() + "\" style=\"height:21px;width:200px;\">\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
