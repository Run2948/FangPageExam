...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("            })\r\n");
	ViewBuilder.Append("            PageNav(\"系统文件管理,global/" + pagename.ToString() + "\");\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	ViewBuilder.Append("                          <li style=\"background: url(../images/refresh.gif) 2px 6px no-repeat\"><a href=\"sysfilesmanage.aspx?sitepath=" + m_path.ToString() + "\">刷新</a></li>\r\n");
	ViewBuilder.Append("                          <li style=\"background: url(../images/back.png) 2px 6px  no-repeat\"><a href=\"" + reurl.ToString() + "\">返回</a></li>\r\n");
	ViewBuilder.Append("                          <li style=\"float:right; width:auto\"><strong>系统文件管理</strong></li>\r\n");
	ViewBuilder.Append("                    </ul>\r\n");
	...
	ViewBuilder.Append("                   <a href=\"sysfilesmanage.aspx?path=" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\">" + files["name"].ToString().Trim() + "</a>\r\n");
	...
	ViewBuilder.Append("                   <a href=\"sysfileedit.aspx?path=" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\">" + files["name"].ToString().Trim() + "</a>\r\n");
	...
	ViewBuilder.Append("                          <a href=\"" + webpath.ToString() + "" + files["name"].ToString().Trim() + "\" target=\"_blank\">" + files["name"].ToString().Trim() + "</a>\r\n");

	}
	else
	{

	ViewBuilder.Append("                          <a href=\"" + webpath.ToString() + "" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\" target=\"_blank\">" + files["name"].ToString().Trim() + "</a>\r\n");
	...
	ViewBuilder.Append("                  <a href=\"sysfilesmanage.aspx?path=" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\">打开</a>\r\n");
	...
	ViewBuilder.Append("                  <a href=\"sysfileedit.aspx?path=" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\">编辑</a>\r\n");

	}
	else
	{

	ViewBuilder.Append("                  <a href=\"" + webpath.ToString() + "" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\">打开</a>\r\n");
